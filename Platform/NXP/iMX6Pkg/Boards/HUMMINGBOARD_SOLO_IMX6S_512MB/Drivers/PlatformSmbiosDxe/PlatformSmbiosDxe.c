/** @file
  Static SMBIOS Table for ARM platform - iMX6 Solo
...
CHAR8  *mSysInfoType1Strings[] = {
  ...
  "1.5",
  "System Serial#",
  "SRMX6SOWT1D512E008V15C0", // SolidRun SKU for iMX6 Solo SoM (in this case v1.5 - unfused)
  "Windows IoT Core",
  NULL
};
...
/***********************************************************************
	iMX6 Solo SMBIOS data definition  TYPE9  System Slot Information
************************************************************************/
