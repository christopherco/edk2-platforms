/** @file
  Static SMBIOS Table for ARM platform - iMX6 Dual
...
CHAR8  *mSysInfoType1Strings[] = {
  ...
  "1.5",
  "System Serial#",
  "SRMX6DUWT1D01GE008V15C0", // SolidRun SKU for iMX6 Dual SoM (in this case v1.5 - unfused)
  "Windows IoT Core",
  NULL
};
...
CHAR8  *mBoardInfoType2Strings[] = {
  ...
  "SRHBCEE008CV12", // Hummingboard carrier board SKU (v1.2 in this case)
  NULL
};
...
/***********************************************************************
	iMX6 Dual SMBIOS data definition  TYPE9  System Slot Information
************************************************************************/
