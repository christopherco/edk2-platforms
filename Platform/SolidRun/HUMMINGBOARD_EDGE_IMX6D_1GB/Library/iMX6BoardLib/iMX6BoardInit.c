/** @file
*
* contains initalization code for iMX6 Dual SOM.
*
...
typedef enum {
    ...
    IMX_PAD_CFG_GPIO06 = _IMX_MAKE_PADCFG(
                              IMX_SRE_SLOW,
                              IMX_DSE_40_OHM,
                              IMX_SPEED_MEDIUM,
                              IMX_ODE_DISABLE,
...
/**
  ...
  to ungate clocks as needed. Not used for iMX6DL or Solo
**/
...
/**
  Initialize clock and power for modules on the iMX6 Dual SOM.
**/
VOID ImxClkPwrInit ()
{
  EFI_STATUS status;
...
/**
  Initialize SDHC2 module on the SOC and perform required pin-muxing for iMX6 Dual
**/
VOID SdhcInit ()
{
  //
...
/**
  Initialize PCI Express module on the Dual SOC and perform required pin-muxing
**/
VOID PcieInit ()
{
    //
...
VOID UartInit ()
{
    ...
    //
    // 2. Dual pin mux for UART 1 and UART 3
    //
