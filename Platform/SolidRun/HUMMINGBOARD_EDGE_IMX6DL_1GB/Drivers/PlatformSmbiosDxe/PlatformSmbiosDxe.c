/** @file
  Static SMBIOS Table for ARM platform - iMX6 Dual Light
...
CHAR8  *mSysInfoType1Strings[] = {
  ...
  "1.5",
  "System Serial#",
  "SRMX6DLWT1D01GE008V15C0", // SolidRun SKU for iMX6 DualLite SoM (in this case v1.5 - unfused)
  "Windows IoT Core",
  NULL
};
...
SMBIOS_TABLE_TYPE2  mBoardInfoType2 = {
  ...
  0,                        // ChassisHandle;
  BaseBoardTypeProcessorMemoryModule, // BoardType;
  0,                        // NumberOfContainedObjectHandles;
  { 0 }                     // ContainedObjectHandles[1];
};
CHAR8  *mBoardInfoType2Strings[] = {
  "SolidRun",
  "HummingBoard DualLite",
  "1.3",
  "Base Board Serial#",
  "Base Board Asset Tag#",
  "SRBHBCEE008CV13", // Hummingboard carrier board SKU (v1.3 in this case)
  NULL
};
...
SMBIOS_TABLE_TYPE4 mProcessorInfoType4 = {
  ...
  ProcessorFamilyARMv7,   // ProcessorFamily2;      ///< The enumeration value from PROCESSOR_FAMILY2_DATA.
};
...
SMBIOS_TABLE_TYPE7  mCacheInfoType7U2 = {
  ...
  1,                        // SocketDesignation String
  0x018A,					// Cache Configuration
  0x0200,					// Maximum Size 512 kB
  0x0200,					// Install Size 512 kB
  {                         // Supported SRAM Type
	0,  //Other             :1
	0,  //Unknown           :1
	0,  //NonBurst          :1
...
/***********************************************************************
	iMX6 DuaLite SMBIOS data definition  TYPE9  System Slot Information
************************************************************************/
SMBIOS_TABLE_TYPE9  mSysSlotInfoType9 = {
  ...
  SlotDataBusWidth8Bit,     // SlotDataBusWidth;         /// SD card slot is capable of 8-bit wide transfers
...
SMBIOS_TABLE_TYPE16 mPhyMemArrayInfoType16 = {
  ...
  0x00000000ULL,                  // ExtendedMaximumCapacity (0) MaximumCapacity is used
};
...
/***********************************************************************
	helper function for TYPE1  System Information UUID convertion
************************************************************************/
VOID
I64ToHexString(
...
/***********************************************************************
	SMBIOS data helper function to obtain platform id
************************************************************************/
UINT64 ObtainPlatformId(VOID)
{
   ...
   const UINT32 RegOCOTP_CFG0Addr=0x021BC410; // OTP Bank0 Word1 contains 32 bits of the Unique ID and SJC_CHALLENGE field
   const UINT32 RegOCOTP_CFG1Addr=0x021BC420; // OTP Bank0 Word2 contains 32 bits of the Unique ID and SJC_CHALLENGE field

   BoardSerial = ((UINT64)(MmioRead32(RegOCOTP_CFG1Addr))) << 32;         // varies, 181A61D4h, 0D0A99D4h
   BoardSerial = BoardSerial | ((UINT64)(MmioRead32(RegOCOTP_CFG0Addr))); // typical E31698D1 

   DEBUG((EFI_D_INFO, "Hummingboard Dual ser no %08X%08Xh \r\n", (UINT32)(BoardSerial>>32), (UINT32)BoardSerial)); // 181A61D4E31698D1h 
  ...
  )
{
   ...
   const UINT32 RegOCOTP_CFG2Addr=0x021BC430; // OTP Bank0 Word3 reflects value of OTP Bank 0, word 3
   ...
   // construct string for making UUID for iMX6 board from : fixed prefix + board serial number printed in hex

   mSysInfoType1.Uuid.Data1=((UINT32)'H'<<24) | ((UINT32)'M'<<16) | ((UINT32)'B'<<8) | (UINT32)'D' ;
   mSysInfoType1.Uuid.Data2=(UINT16)Bank0Word3; 
   mSysInfoType1.Uuid.Data3=(UINT16)(Bank0Word3>>16); 

   for(k=7; k>=0; k--) { // 8 bytes of board Unique ID
    
      mSysInfoType1.Uuid.Data4[7-k]=(UINT8)(BoardSerial>>(k*8));
   }

   // example of GUID created 484D4245-0000-0000-181A6-61D4E31698D1
  ...
  )
{
  ...
  // lower bits 0 -39 are less likely to be different between instances of iMX6.

  ChassisSerialNo = (UINT8)(ObtainPlatformId() >> 40);  
  DEBUG((EFI_D_INFO, "Chassis Board Serial %02Xh \r\n", ChassisSerialNo));
