    ...
    )
{
    ...
    do {
        ...
        if (I2cMPhyStat0Reg.i2cmphyerror)
        {
            // TODO : Error bit is always asserted, why?
            //break;
        }
    ...
    )
{
    ...
    // Temporary workaround for 1080p, need clarification from NXP about this.
    // Instead of reducing HActive, we reduce 3x of blanks to preserve
    // framebuffer size. Without this workaround display would appear out of
    // range intermittently. Workaround was based on previous Freescale BSP.
    ...
    )
{
    ...
    // a well - defined state
    {
        ...
        // TODO Do we need to program HDMI_PHY_TST0 too?
    }
    ...
    // TODO Figure out how to setup voltage
    // Enable clock symbol
    if (HDMIPhyI2cWrite(
            HdmiDisplayContextPtr,
    ...
    // TODO Odetermine the right voltage level
    if (HDMIPhyI2cWrite(
            HdmiDisplayContextPtr,
            HDMI_PHY_VLEVCTRL, 
            0x0210) == 0) {
